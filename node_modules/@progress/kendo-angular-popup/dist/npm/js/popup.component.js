...
/***/ function(module, exports, __webpack_require__) {
	...
	var PopupComponent = (function () {
	    function PopupComponent(_alignService, container, _positionService, _renderer) {
	    ...
	    PopupComponent.prototype.align = function () {
	        this.offset = this._alignService.alignElement({
	            anchor: this.anchor,
	    ...
	    PopupComponent.prototype.position = function () {
	        var _a = this._positionService.positionElement({
	            anchor: this.anchor,
	            anchorAlign: this.anchorAlign,
	            collisions: this.collision,
	            currentLocation: this.offset,
	            element: this.container,
	            elementAlign: this.popupAlign
	        }), flipped = _a.flipped, offset = _a.offset;
	        if (this.animate) {
	            this.direction = flipped ? 'up' : 'down';
	        }
	        else {
	            this.direction = 'none';
	        }
	    ...
	    PopupComponent = __decorate([
	        core_1.Component({
	            ...
	            providers: [align_service_1.AlignService, dom_service_1.DOMService, position_service_1.PositionService],
	            selector: 'kendo-popup',
	            template: "\n        <div class=\"k-popup\" [ngClass]=\"popupClass\" [@toggle]=\"direction\">\n            <ng-content></ng-content>\n        </div>\n     "
	        }), 
	        __metadata('design:paramtypes', [align_service_1.AlignService, core_1.ElementRef, position_service_1.PositionService, core_1.Renderer])
	    ], PopupComponent);
