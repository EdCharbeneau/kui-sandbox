...
import { OnInit, OnDestroy, AfterContentChecked, AfterViewInit } from '@angular/core';
import { ButtonGroupSelection } from './selection-settings';
import { KendoButtonService } from './button.service';
/**
 * Represents the Kendo UI ButtonGroup component for Angular.
 */
export declare class ButtonGroupComponent implements OnInit, OnDestroy, AfterContentChecked, AfterViewInit {
    private service;
    /**
