...
/***/ function(module, exports, __webpack_require__) {
	...
	var button_directive_1 = __webpack_require__(7);
	...
	var ButtonGroupComponent = (function () {
	    ...
	    Object.defineProperty(ButtonGroupComponent.prototype, "aria", {
	        get: function () {
	    ...
	    ButtonGroupComponent.prototype.verifySettings = function () {
	        if (core_1.isDevMode()) {
	            if (this.selection === 'single' && this.buttons.filter(function (button) { return button.selected; }).length > 1) {
	    ...
	    ], ButtonGroupComponent.prototype, "aria", null);
	    __decorate([
	    ...
	    ButtonGroupComponent = __decorate([
	        core_1.Component({
	            ...
	            template: "\n      <div class=\"k-button-group\"><ng-content select=\"[kendoButton]\"></ng-content></div>\n      "
	        }), 
...
/***/ function(module, exports) {
	...
	module.exports = require("./button.directive");
