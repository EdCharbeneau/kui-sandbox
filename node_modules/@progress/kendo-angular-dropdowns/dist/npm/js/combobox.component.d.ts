 ...
 * ```
 */
export declare class ComboBoxComponent implements ControlValueAccessor, OnInit, OnDestroy {
    text: any;
    dataItem: any;
    selected: any[];
    show: boolean;
    ...
    protected template: ItemTemplateDirective;
    ...
    private wrapper;
    constructor(selectionService: SelectionService, wrapper: ElementRef);
    ...
    protected search(value: any): void;
    protected setHeaderClasses(): Object;
    protected navigate(index: number): void;
    protected handleNavigate(event: any): void;
    handleSearchBarChange(text: string): void;
    handleFilter(text: string): void;
    protected handleBlur(): void;
    protected change(dataItem: any, isCustom?: boolean): void;
